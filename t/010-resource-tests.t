...
my @tests = (
    ...
    },
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,c4'
    },
    # ... (langauge doesn't match, but content type does)
    {
        ...
        response => [ 406, [ 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,d5'
    },
    {
        resource => 'D5',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,c4,d4,d5'
    },
    # ... (content type and language match, but charset doesn't)
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,d5,e5,e6'
    },
    {
        resource => 'E6',
        request  => { REQUEST_METHOD => 'GET', HTTP_ACCEPT_LANGUAGE => 'de', HTTP_ACCEPT_CHARSET => 'iso-8859-5' },
    ...
    },
    {
        ...
        response => [ 406, [ 'Content-Type' => 'text/plain', 'Content-Language' => 'de' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,c4,d4,d5,e5,e6'
    },
    # ... (no encoding asked for, and no identity provided, but content-type, language and charset matches)
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,c4,d4,d5,e5,e6,f6'
    },
    {
        resource => 'F6',
        request  => { REQUEST_METHOD => 'GET', HTTP_ACCEPT_LANGUAGE => 'de', HTTP_ACCEPT_CHARSET => 'utf-8' },
        response => [ 406, [ 'Content-Language' => 'de', 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,d5,e5,e6,f6'
    },
    {
        resource => 'F6',
        request  => { REQUEST_METHOD => 'GET', HTTP_ACCEPT_LANGUAGE => 'de' },
        response => [ 406, [ 'Content-Language' => 'de', 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,d5,e5,f6'
    },
    {
        resource => 'F6',
        request  => { REQUEST_METHOD => 'GET' },
        response => [ 406, [ 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6'
    },
    # ... (same as F6, but now we are asking for an encoding)
    {
        ...
        response => [ 406, [ 'Content-Language' => 'de', 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,c4,d4,d5,e5,e6,f6,f7'
    },
    {
        resource => 'F7',
        request  => { REQUEST_METHOD => 'GET', HTTP_ACCEPT_LANGUAGE => 'de', HTTP_ACCEPT_CHARSET => 'utf-8', HTTP_ACCEPT_ENCODING => 'gzip' },
        response => [ 406, [ 'Content-Language' => 'de', 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,d5,e5,e6,f6,f7'
    },
    {
        resource => 'F7',
        request  => { REQUEST_METHOD => 'GET', HTTP_ACCEPT_LANGUAGE => 'de', HTTP_ACCEPT_ENCODING => 'gzip' },
        response => [ 406, [ 'Content-Language' => 'de', 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,d5,e5,f6,f7'
    },
    {
        resource => 'F7',
        request  => { REQUEST_METHOD => 'GET', HTTP_ACCEPT_ENCODING => 'gzip' },
        response => [ 406, [ 'Content-Type' => 'text/plain' ], ['Not Acceptable'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,f7'
    },
    # ... (test out all the different variance scenarios, this really is testing G7, but H7 is the terminal node)
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,c4,d4,d5,e5,e6,f6,f7,g7,h7'
    },
    {
        resource => 'H7b',
        request  => { REQUEST_METHOD => 'GET', HTTP_ACCEPT => 'text/plain', HTTP_ACCEPT_LANGUAGE => 'de', HTTP_ACCEPT_CHARSET => 'utf-8', HTTP_ACCEPT_ENCODING => 'gzip', HTTP_IF_MATCH => '*' },
    ...
    # ...
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,g9,g11'
    },
    # ... H12 via G8->H10->H11
    {
        resource => 'H12',
        ...
        response => [ 412, [ 'Content-Encoding' => 'gzip', 'Content-Type' => 'text/plain' ], ['Precondition Failed'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,h11,h12'
    },
    # ... H12 via G8->G9->H10->H11
    {
        ...
        response => [ 412, [ 'Content-Encoding' => 'gzip', 'Content-Type' => 'text/plain' ], ['Precondition Failed'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,g9,h10,h11,h12'
    },
    # ... H12 via G8->G9->G11->H10->H11
    {
        ...
        response => [ 412, [ 'Content-Encoding' => 'gzip', 'Content-Type' => 'text/plain' ], ['Precondition Failed'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,g9,g11,h10,h11,h12'
    },
    # ... I4 via H7->I7
    {
        resource => 'I4',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,i4'
    },
    {
        resource => 'I4b',
        request  => { REQUEST_METHOD => 'PUT', HTTP_IF_MATCH => '0xDEADPORK' },
    ...
    # ... J18 via H10->I12->I13
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,j18'
    },
    {
        resource => 'J18',
    ...
    # ... J18 via H10->H11->H12->I12->I13
    {
        ...
        response => [ 304, [ 'ETag' => '"0xDEADBEEF"', 'Last-Modified' => 'Sun, 18 Mar 2012 15:45:00 GMT'  ], [] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,h11,h12,i12,i13,j18'
    },
    {
        resource => 'J18',
    ...
    # ... J18 via H10->I12->I13->K13
    {
        ...
        response => [ 304, [ 'ETag' => '"0xDEADBEEF"', 'Last-Modified' => 'Sun, 18 Mar 2012 15:45:00 GMT'  ], [] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,j18'
    },
    {
        resource => 'J18',
    ...
    # ...
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,i4,p3'
    },
    {
        resource => 'P3b',
        request  => { REQUEST_METHOD => 'PUT' },
    ...
    # ... K5 via H7->I7->K7
    {
        ...
        request  => { REQUEST_METHOD => 'GET' },
        response => [ 301, [ 'Location' => '/foo/bar', 'Content-Type' => 'text/plain' ], [] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5'
    },
    {
        resource => 'K5b',
        request  => { REQUEST_METHOD => 'GET' },
    ...
    # ... L7 via H7->I7->K7
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,l7'
    },
    # ... M7 via H7->I7->K7->L7
    {
        resource => 'M7',
        ...
        response => [ 404, [ 'Content-Type' => 'text/plain' ], ['Not Found'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,l7,m7'
    },
    # ... L5 via H7->I7->K7->K5
    {
        resource => 'L5',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5,l5'
    },
    {
        resource => 'L5b',
        request  => { REQUEST_METHOD => 'GET' },
    ...
    # ... M5 via H7->I7->K7->K5->L5
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5,l5,m5'
    },
    # ... N5 via H7->I7->K7->K5->L5->M5
    {
        ...
        request  => { REQUEST_METHOD => 'POST' },
        response => [ 410, [ 'Content-Type' => 'text/plain' ], ['Gone'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5,l5,m5,n5'
    },
    # send a content type we dont handle
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5,l5,m5,n5,n11'
    },
    # ...
    {
        resource => 'N11b',
    ...
    # ... P11 via H7->I7->K7->K5->L5->M5->N5->N11
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5,l5,m5,n5,n11,p11'
    },
    ...
    # ...
    {
        ...
        request  => { REQUEST_METHOD => 'PUT', CONTENT_TYPE => 'text/plain' },
        response => [ 201, [ 'Location' => '/foo/bar/baz', 'Content-Type' => 'text/plain' ], [] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,i4,p3,p11'
    },
    # O18 via N11
    {
        resource => 'O18',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5,l5,m5,n5,n11,p11,o20,o18,o18b'
    },
    {
        resource => 'O18b',
        request  => { REQUEST_METHOD => 'POST' },
    ...
    # ...
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,i4,p3,p11,o20,o18,o18b'
    },
    # O20 via N11
    {
        resource => 'O20',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,k7,k5,l5,m5,n5,n11,p11,o20'
    },
    {
        resource => 'O20b',
        request  => { REQUEST_METHOD => 'PUT', CONTENT_TYPE => 'text/plain' },
        response => [ 204, [ 'Content-Type' => 'text/plain' ], [] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,h7,i7,i4,p3,p11,o20'
    },
    # L17 via L13,L14,L15,L16
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,l17'
    },
    # M20 via L15,M16
    {
        resource => 'M20',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,m16,m20,m20b'
    },
    {
        resource => 'M20b',
        request  => { REQUEST_METHOD => 'DELETE', HTTP_IF_NONE_MATCH => '0xDEADPORK', HTTP_IF_MODIFIED_SINCE => '18 Mar 2036 15:49:00 GMT' },
        response => [ 500, [ 'Content-Encoding' => 'gzip', 'Content-Type' => 'text/plain' ], ['Internal Server Error'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,m16,m20'
    },
    # O20
    {
        resource => 'O20c',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,m16,m20,m20b,o20'
    },
    # O18
    {
        resource => 'O18c',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,m16,m20,m20b,o20,o18,o18b'
    },
    # N11
    {
        resource => 'N11h',
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,m16,n16,n11'
    },
    # O14
    {
        resource => 'O14',
        ...
        response => [ 409, [ 'Content-Type' => 'text/plain' ], ['Conflict'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,m16,n16,o16,o14'
    },
    {
        resource => 'O14b',
    ...
    # P11
    {
        ...
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,i13,k13,l13,l14,l15,m16,n16,o16,o14,p11'
    },
    # O18e
    {
        resource => 'O18e',
        ...
        response => [ 200, [ 'Content-Length' => 11, 'Content-Type' => 'text/plain' ], [ 'HELLO WORLD' ] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,l13,m16,n16,o16,o18,o18b'
    },
    {
        resource => 'O18e',
    ...
    },
    {
        ...
        request  => { REQUEST_METHOD => 'GET', CONTENT_TYPE => 'text/plain' },
        response => [ 500, [ 'Content-Type' => 'text/plain' ], ['Internal Server Error'] ],
        trace    => 'b13,b12,b11,b10,b9,b8,b7,b6,b5,b4,b3,accept_datetime_exists,c3,d4,e5,f6,g7,g8,h10,i12,l13,m16,n16,o16,o18'
    },
);
